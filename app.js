...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var theMessage1 = a + ' and ' + b + ' and ' + c + ' sum to ' + sum2[0] + '.';
  var theMessage2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product2[0] + '.';

return [sum2[0], product2[0], theMessage1, theMessage2];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var theMessage = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sum2[0] + ' is their sum.';

  return [sum2[0], theMessage];
}
...
function multiplyArray(multArr) { //eslint-disable-line
 ...
 var theMessage = 'The numbers '  + multArr[0] + ',' + multArr[1] + ',' +  multArr[2] + ' have a product of 24.';

 return [product2[0], theMessage];
}
